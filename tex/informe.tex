...
Realizamos un análisis de redes utilizando paquetes ARP.
...
Los paquetes del protocolo tienen dos objetivos y pueden separarse en: paquetes de petición y de respuesta.
\begin{itemize}
	\item Los paquetes de petición (who-has) son enviados en forma de broadcast con el objetivo de poder localizar la dirección MAC a la cuál le pertenece un IP en especial.
	\item Los paquetes de respuesta (is-at) son enviados de manera uni-cast ya que se utilizan para responder a la máquina que realizó una petición con anterioridad.
\end{itemize}
...
\begin{tabular}{| l | p{10cm} |}
	\hline
	Operación & Especifcia la operación que el emisor está realizando, 1 para petición, 2 para responder \\ \hline
...
El análisis de la red consiste en reconocer su topología en base al nivel de información que proveen las diferentes IP's, tanto como fuente o como destino, tomando a las IP's como símbolos y calculando su probabilidad de aparición según su frecuencia muestral.
...
\include{altopalermo-destination}
...
\include{mcdonalds-source}


\subsubsection{Direcciones IP destino de paquetes ARP \emph{who-has} modeladas como fuentes de información}
\include{mcdonalds-destination}
...
\include{starbucks-source}


\subsubsection{Direcciones IP destino de paquetes ARP \emph{who-has} modeladas como fuentes de información}
\include{starbucks-destination}
