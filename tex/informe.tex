...
\subsection{Paquetes ARP \textit{who-has} emitidos desde un único nodo origen hacia distintos nodos destino}
...
Teniendo en cuenta lo anterior, interpretamos que este escenario es producido por un router que intenta mantener actualizada su tabla ARP emitiendo paquetes ARP \textit{who-has} periódicamente para cada dirección IP en dicha tabla, bajo la suposición que cada dirección IP es asignada a distintos hosts que se conectan y desconectan de la red a medida que pasa el tiempo.


\subsection{Paquetes ARP \textit{who-has} emitidos desde un único nodo origen hacia un único nodo destino}
