...
\subsection{Red \emph{Starbucks}}
La red de Starbucks analizada, es facil notar en el grafo de la red dos fenómenos, la alta cantidad de paquetes ARP con destino y fuente 10.254.31.1 y los paquetes ARP que poseen como fuente a la ip 0.0.0.0 y tiene destinos múltiples.
...
Además de estos dos fenómenos notorios, también pueden encontrarse IP del rango 169.254.0.0/16 lo que muestra nuevas conecciones a la red.
